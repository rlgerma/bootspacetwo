          ...
          <Row>
            <Col lg={12} sm={22}>
              <div className='section'>
                ...
                <p>
                  With all of the recruiter spam on social networking sites like LinkedIn,
                  isn&apos;t it time for something better? At BootSpace, people you <em>care</em>{" "}
                  about stay engaged no matter where you&apos;re posting from - while other&apos;s{" "}
                  <em>won&apos;t</em>.
                </p>
                <h2 className='heading'>
                ...
                <p>
                  Instead of adding to your overstuffed email inbox, conversations in BootSpace
                  happen in dedicated spaces called <span>friend-zones</span>.
                </p>
                <h2 className='heading'>
