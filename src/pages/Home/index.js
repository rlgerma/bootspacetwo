          ...
          <Row>
            <Col lg={12} sm={22}>
              <div className='section'>
                ...
                <p>
                  Instead of adding to your overstuffed email inbox,
                  conversations in BootSpace happen in dedicated spaces called{" "}
                  <span>friend-zones</span>.
                </p>
                <h2 className='heading'>
                  Get looped <span style={{ color: "#42e089" }}>in</span>, not
                  out
                </h2>
                <p>
